...
import './save-image.scss';

const SaveImage = ({saveImage, showDownloadButton}) => {

	if(showDownloadButton){
		return (
			<div className='save-wrapper' onClick={saveImage}>
				<svg className='save-wrapper__icon' role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
